...
-- changeset geocodes:init_core_geocodes.sql
...
--
DELETE FROM core_user_right WHERE id_right = 'GEOCODES_MANAGEMENT';
INSERT INTO core_user_right (id_right,id_user) VALUES ('GEOCODES_MANAGEMENT',1);
